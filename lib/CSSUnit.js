...
class CSSUnit extends Number {
    ...
    get vh() {
        return this.value ? roundNumber(this.value * 100, CSSUnit.options.maxDecimalPlaces) + 'vh' : '0';
    }

    get vmin() {
        return this.value ? roundNumber(this.value * 100, CSSUnit.options.maxDecimalPlaces) + 'vmin' : '0';
    }

    get vmax() {
        return this.value ? roundNumber(this.value * 100, CSSUnit.options.maxDecimalPlaces) + 'vmax' : '0';
    }
}
